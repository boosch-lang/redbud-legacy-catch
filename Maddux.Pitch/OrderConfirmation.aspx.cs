            ...
            using (var db = new MadduxEntities())
            {
                ...
                if (order != null)
                {
                    ...
                    if (order.OrderDate != null)
                        lblOrderDate.InnerText = order.OrderDate?.ToString("MMMM d, yyyy");
                    else
                    {
                        lblOrderDate.InnerText = "N/A";
                    }
                    ...
                    pSubtotal.InnerText = order.SubTotal.ToString("C");
                    TaxTypeText.InnerText = TaxUtilities.GetTaxTypeText(order.ShippingState);
