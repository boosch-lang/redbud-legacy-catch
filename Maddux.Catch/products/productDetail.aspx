<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Maddux.Catch.Master" CodeBehind="productDetail.aspx.cs" Inherits="Maddux.Catch.products.productDetail" %>
                    ...
                    <div id="productDetails" style="padding:15px" class="panel-collapse collapse in" aria-expanded="true">
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <label class="font-weight-bold">Catalog:</label>
                                        <asp:DropDownList ID="ddCatalog" runat="server" DataTextField="Text" DataValueField="Value"
                            ...
                            <div class="col-xs-6">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <label class="font-weight-bold required">Unit Cost:</label>
                                        <asp:TextBox ID="txtUnitCost" type="number" runat="server" step="any" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator runat="server" ID="reqUnitCost" ControlToValidate="txtUnitCost" ErrorMessage="Unit cost is required" />
                                    </div>
                                    <asp:CompareValidator runat="server" Operator="DataTypeCheck" Type="Double"
                                        ControlToValidate="txtUnitCost" ErrorMessage="Unit Cost must be a number." />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <label class="font-weight-bold">Item Number (Internal):</label>
                            ...
                            <div class="col-xs-6">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <label class="font-weight-bold required">Case Price:</label>
                                        <asp:TextBox ID="txtUnitPrice" type="number" runat="server" step="any" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator runat="server" ID="reqUnitPrice" ControlToValidate="txtUnitPrice" ErrorMessage="Case price is required." />
                                        <asp:CompareValidator runat="server" Operator="DataTypeCheck" Type="Double"
                                            ControlToValidate="txtUnitPrice" ErrorMessage="Case Price must be a whole number." />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <label class="font-weight-bold">Item Number (Customer):</label>
